...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-lg-7 col-md-12">
            <div class="card">
                <div class="card-header"><h2>factura information: {{ $factura->name }}</h2></div>
                    ...
                    @method('PUT')
                        <div class="container">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="name" placeholder="name" name="name" value="{{ old('name', $factura->name) }} readonly">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" id="slug" placeholder="Slug" name="slug" value="{{ old('slug', $factura->slug) }} readonly">
                            </div>

                            <div class="form-group">
                                <textarea class="form-control" placeholder="Description" id="description" name="description" rows="3" readonly>{{ old('description', $factura->description) }}</textarea>
                            </div>
                            ...
                            @can('haveaccess', 'factura.edit')
                                <a class="btn btn-success" href="{{ route('factura.edit', $factura->id) }}">Edit</a>
                            @else
        ...
        <div class="col-lg-4 col-12">
            <div class="card">
                <div class="card-header"><h2>Users with this factura</h2></div>
